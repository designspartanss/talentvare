    ...
    return (
        <nav className="navbar navbar-expand-lg bg-white shadow-sm px-1 px-sm-3">
            <div className="container-fluid">
                <a className="navbar-brand me-xl-5" href="#">
                ...
                <button
                    className={`navbar-toggler ms-auto me-3 ${isOffcanvasOpen ? 'active' : ''}`}
                    type="button"
                ...
                <div className="d-flex">
                    ...
                    <img
                        ...
                        alt="Profile"
                        className="ms-2 image_styles d-none d-sm-block d-lg-none d-xl-block"
                        width="40"
                        height="40"
                    />
                </div>
